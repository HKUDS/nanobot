...
4. For claims from memory sections (marked "from previous sessions") — did you verify them
   with a tool this session? If not, either verify now or attribute them: "Based on
   previous sessions..."
