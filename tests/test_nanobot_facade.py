...
def test_import_from_top_level():
    from nanobot import Nanobot as NanobotClass
    from nanobot import RunResult as RunResultClass

    assert NanobotClass is Nanobot
    assert RunResultClass is RunResult
