...
def test_configured_spawn_presets_excludes_synthetic_default() -> None:
    from nanobot.agent.model_presets import configured_spawn_presets
    ...
    result = configured_spawn_presets(config)
