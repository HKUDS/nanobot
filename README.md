...
| `agents.defaults.historyMaxChars` | `0` | Max characters for `memory/HISTORY.md`; `0` = no limit. When exceeded, the file is trimmed from the start to avoid unbounded growth. |
