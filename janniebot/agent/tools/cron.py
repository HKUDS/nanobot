...
from janniebot.agent.tools.schema import (
    BooleanSchema,
    IntegerSchema,
    StringSchema,
...
from janniebot.cron.types import CronJob, CronJobState, CronSchedule
...
@tool_parameters(
    tool_parameters_schema(
        ...
        message=StringSchema(
            ...
            "(e.g., 'Send a reminder on Telegram: xxx' or 'Check system status and report')"
        ),
