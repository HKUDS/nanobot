...
class GitStore:
    ...
    def init(self) -> bool:
        ...
        try:
            ...
            porcelain.commit(
                str(self._workspace),
                message=b"init: janniebot memory store",
                author=b"janniebot <janniebot@dream>",
                committer=b"janniebot <janniebot@dream>",
            )
    ...
    def revert(self, commit: str) -> str | None:
        ...
        try:
            ...
            with Repo(str(self._workspace)) as repo:
                ...
                tree = cast(Any, repo[parent_obj.tree])
