...
| `cheaperinference` | LLM gateway for Cheaper Inference's OpenAI-compatible model catalog. Each model costs 15–60% less than the list price of its lab. | [cheaperinference.com](https://cheaperinference.com/signup) |
