...
describe("App layout", () => {
  ...
  it("accepts the integrations settings hash and preserves the active sidebar section", async () => {
    ...
    // The settings bundle is loaded lazily; coverage workers can take over 1s.
    expect(await screen.findByRole("heading", { name: "Status integracji" }, { timeout: 5000 })).toBeInTheDocument();
