...
- Memory index: {{ workspace_path }}/memory/MEMORY_INDEX.md (compressed summary, always in context)
- Use the `recall_memory` tool to retrieve specific details from long-term memory when needed.
