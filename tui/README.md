...
is focused to attach an image from the system clipboard. Image bytes stay behind editable
`[Image #n]` placeholders until the message is sent; deleting a placeholder removes its image.
