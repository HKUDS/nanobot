...
def onboard():
    ...
    console.print("\n[dim]Want Telegram/WhatsApp? See: https://github.com/HKUDS/scorpion#-chat-apps[/dim]")
...
def _get_bridge_dir() -> Path:
    ...
    user_bridge = Path.home() / ".scorpion" / "bridge"
    ...
    pkg_bridge = Path(__file__).parent.parent / "bridge"  # scorpion/bridge (installed)
    ...
    if not source:
        ...
        console.print("Try reinstalling: pip install --force-reinstall scorpion")
        raise typer.Exit(1)
