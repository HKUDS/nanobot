...
from blackcat.agent.tools.web import WebFetchTool, _validate_url
...
def _patch_env():
    return patch("blackcat.security.network.socket.getaddrinfo", _fake_resolve_public), \
           patch("blackcat.agent.tools.web.httpx.AsyncClient", FakeClient)
