...
class AgentLoop:
    ...
    async def process_direct(
        ...
        """Process a message directly (for CLI, cron, or API usage).

        Returns DirectResponse with content, usage, and accumulated tool proposals.
        """
        await self._connect_mcp()
        ...
        return DirectResponse(
            ...
            proposals=proposals,
            metadata=dict(response.metadata) if response and hasattr(response, "metadata") else {},
        )
