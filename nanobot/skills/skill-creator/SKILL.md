---
name: skill-creator
description: Create new skills, modify and improve existing skills, and measure skill performance. Use when users want to create a skill from scratch, edit, or optimize an existing skill, run evals to test a skill, or benchmark skill performance with variance analysis. 当用户提及创建技能、写skill、改技能、优化技能、技能测试时，务必先读取此技能。
---
