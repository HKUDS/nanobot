...
class RagConfig(BaseModel):
    ...
    llm_model_name: str = "ministral-8b"
    llm_base_url: str = "http://bifrost:3505/v1"
    llm_api_key: str = "dummy"
    # Embedding settings
    embed_binding: str = "openai"
    embed_endpoint: str = "http://bifrost:3505/v1"
    embed_dimension: int = 1024
    embed_model_name: str = "text-embedding-3-small"
    embed_api_key: str = "dummy"
