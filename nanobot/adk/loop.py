...
class AdkAgentLoop:
    ...
    def __init__(
        ...
        # ADK session service (in-memory — nanobot JSONL is the persistence layer)
    ...
    async def _connect_mcp(self) -> None:
        ...
        try:
            from nanobot.adk.mcp_bridge import connect_mcp_servers_adk
    ...
    def _save_turn_simple(
        ...
        """Save a turn into the nanobot JSONL session."""
