...
class AgentLoop:
    ...
    def _register_default_tools(self) -> None:
        ...
        # Register tools from skill.py modules (custom skills)
        for skill_tool in self.context.skills.load_skill_tools():
            if not self.tools.has(skill_tool.name):
                self.tools.register(skill_tool)
                logger.debug("Registered skill tool: {}", skill_tool.name)
