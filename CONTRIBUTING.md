# Contributing to janniebot

Thank you for being here.

janniebot is built with a simple belief: good tools should feel calm, clear, and humane.
...
# Lint code
ruff check janniebot/

# Format code
ruff format janniebot/
```

## Code Style

We care about more than passing lint. We want janniebot to stay small, calm, and readable.
...
Please feel free to open an [issue](https://github.com/derek14/janniebot/issues) or reach out:

- Email: Xubin Ren (@Re-bin) — <xubinrencs@gmail.com>

Thank you for spending your time and care on janniebot. We would love for more people to participate in this community, and we genuinely welcome contributions of all sizes.
