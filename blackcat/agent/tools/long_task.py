...
``blackcat.session.goal_state.goal_state_runtime_lines``) so compaction cannot hide them.
...
from blackcat.bus.runtime_events import GoalStateChanged, RuntimeEventBus, RuntimeEventContext
