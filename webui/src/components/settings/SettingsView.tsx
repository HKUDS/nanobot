...
function SettingsSidebar({
  ...
  const { t } = useTranslation();
  return (
    <aside className="flex w-full shrink-0 flex-col border-b border-border/55 bg-card/62 px-3 py-4 shadow-[inset_0_-1px_0_rgba(255,255,255,0.55)] backdrop-blur-xl dark:bg-card/45 dark:shadow-none md:w-[17rem] md:border-b-0 md:border-r md:shadow-[inset_-1px_0_0_rgba(255,255,255,0.55)]">
      <button
        type="button"
      ...
      <nav aria-label={t("settings.sidebar.ariaLabel")} className="grid grid-cols-2 gap-1 sm:grid-cols-4 md:block md:space-y-1">
