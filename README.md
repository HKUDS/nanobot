...
| `tools.allowedDirs` | `[]` | List of additional directories the agent can access when `restrictToWorkspace` is true. Paths are in addition to the main workspace. Example: `["~/projects", "/data"]` |
