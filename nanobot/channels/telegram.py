...
class TelegramChannel(BaseChannel):
    ...
    async def _on_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        escaped = content.encode("unicode_escape", "ignore").decode("ascii")
        if len(escaped) > 320:
            escaped = f"{escaped[:320]}..."
        logger.debug(
            "Telegram inbound raw sender={} chat={} text={} caption={} media_type={} media_paths={} chars={} content_esc='{}'",
            sender_id,
