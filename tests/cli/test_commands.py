...
def test_provider_logout_xai_oauth_removes_local_oauth_files(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("nanobot.providers.xai_oauth_auth._keyring_delete", lambda: None)
...
def test_provider_login_xai_oauth_forwards_manual_options(monkeypatch):
    from nanobot.providers.xai_oauth_auth import XaiOAuthCredential
    ...
    monkeypatch.setattr(
        "nanobot.providers.xai_oauth_auth.login_xai_oauth_interactive",
