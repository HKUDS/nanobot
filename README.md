...
| `gemini` | LLM (Gemini direct via AI Studio) | [aistudio.google.com](https://aistudio.google.com) |
| `vertex_ai` | LLM (Google Vertex AI via Google Cloud ADC) | [cloud.google.com/vertex-ai](https://cloud.google.com/vertex-ai) |
