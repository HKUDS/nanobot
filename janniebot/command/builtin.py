...
from janniebot import __version__
from janniebot.bus.events import OutboundMessage
from janniebot.command.router import CommandContext, CommandRouter
from janniebot.utils.helpers import build_status_content
from janniebot.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "janniebot"] + sys.argv[1:])
