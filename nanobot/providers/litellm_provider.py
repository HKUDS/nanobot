...
class LiteLLMProvider(LLMProvider):
    ...
    def __init__(
        ...
        self.is_nvidia = (
            ...
            (api_base and "nvidia" in api_base) or
            "nvidia/" in default_model
        )
    ...
    async def chat(
        ...
        # For NVIDIA endpoints, set custom provider so litellm recognizes the route
        if self.is_nvidia:
            kwargs["custom_llm_provider"] = "nvidia"
