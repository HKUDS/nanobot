...
class Schema(ABC):
    ...
    Concrete types live in :mod:`janniebot.agent.tools.schema`; all implement
...
class Tool(ABC):
    ...
    _tool_parameters_schema: ClassVar[dict[str, Any] | None] = None
    ...
    def parameters(self) -> dict[str, Any]:
        """JSON Schema for tool parameters (override or use :func:`tool_parameters`)."""
...
def tool_parameters(schema: dict[str, Any]) -> Callable[[type[_ToolT]], type[_ToolT]]:
    ...
    def decorator(cls: type[_ToolT]) -> type[_ToolT]:
        ...
        def _parameters_getter(_self: Any) -> dict[str, Any]:
            return deepcopy(frozen)

        cls._tool_parameters_schema = deepcopy(frozen)
        cls.parameters = property(_parameters_getter)  # type: ignore[assignment]
