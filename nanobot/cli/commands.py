...
def serve(
    ...
    local_memory_cfg = LocalMemoryConfig(
        ...
        auto_capture_personal_facts=runtime_config.tools.local_memory.auto_capture_personal_facts,
        auto_capture_session_summaries=runtime_config.tools.local_memory.auto_capture_session_summaries,
...
def _run_gateway(
    ...
    *,
    ...
    local_memory_cfg = LocalMemoryConfig(
        ...
        auto_capture_personal_facts=config.tools.local_memory.auto_capture_personal_facts,
        auto_capture_session_summaries=config.tools.local_memory.auto_capture_session_summaries,
