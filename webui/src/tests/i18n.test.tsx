...
const LOCALIZED_SETTINGS_COPY_KEYS = [
  ...
  "settings.followUpSuggestions.label",
...
const LOCALIZED_NEW_SURFACE_KEYS = [
  ...
  "thread.suggestions.label",
  "thread.suggestions.dismiss",
  "thread.suggestions.dialogTitle",
  "thread.suggestions.dialogDescription",
  "thread.suggestions.appendAndSend",
  "thread.suggestions.replaceAndSend",
