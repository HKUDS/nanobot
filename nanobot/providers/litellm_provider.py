...
class LiteLLMProvider(LLMProvider):
    ...
    async def chat(
        ...
        # GitHub Copilot models pass through directly (LiteLLM handles OAuth)
        is_copilot = model.startswith("github_copilot/")
        ...
        if not is_copilot and self.is_openrouter and not model.startswith("openrouter/"):
