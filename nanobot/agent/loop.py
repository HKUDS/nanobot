...
class AgentLoop:
    ...
    def __init__(
        ...
        disable_history_injection: bool = False,
        ...
        self.context = ContextBuilder(workspace, timezone=timezone, disabled_skills=disabled_skills, disable_history_injection=disable_history_injection)
