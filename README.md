...
> - **DashScope Coding Plan**: Use the dedicated provider `dashscopeCodingPlan` for `https://coding.dashscope.aliyuncs.com/v1`. For international access, override `"apiBase": "https://coding-intl.dashscope.aliyuncs.com/v1"`.
