...
EXPECTED_PROMPTS: dict[str, list[str]] = {
    ...
    "nudge_parallel_structure": ["parallel"],
    "nudge_plan_enforcement": ["plan"],
    "nudge_post_delegation": ["delegat"],
    "nudge_ungrounded_warning": ["unground", "warn"],
    "nudge_use_parallel": ["parallel"],
    "plan": ["plan", "step"],
    "progress": ["progress", "status"],
    "recovery": ["previous attempt", "answer", "tool"],
    "reflect": ["reflect", "what went wrong", "analyz"],
    "revision_request": ["issue", "revis", "concern"],
    "role_code": ["code", "software", "engineer"],
    "role_pm": ["project", "manag"],
    "role_research": ["research"],
    "role_system": ["system", "admin"],
    "role_writing": ["writ"],
