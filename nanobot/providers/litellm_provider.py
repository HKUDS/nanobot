...
class LiteLLMProvider(LLMProvider):
    ...
    def __init__(
        ...
        # Detect OpenRouter by api_key prefix or explicit api_base or explicit provider
        self.is_openrouter = (
        ...
        self.is_vllm = provider == "vllm" or (bool(api_base) and not self.is_openrouter)

        # Configure LiteLLM based on explicit provider or model name
        if api_key:
            if provider == "openrouter" or self.is_openrouter:
                os.environ["OPENROUTER_API_KEY"] = api_key
            elif provider == "vllm" or self.is_vllm:
                ...
                if "deepseek" in default_model:
                    ...
                    os.environ.setdefault("ZHIPUAI_API_KEY", api_key)
                elif "qwen" in default_model.lower() or "dashscope" in default_model:
                    os.environ.setdefault("DASHSCOPE_API_KEY", api_key)
