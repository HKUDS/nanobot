...
SETUP_SPEC = ChannelSetupSpec(
    fields={
        ...
        "technical.enabled": field("bool", default=False),
        "technical.profileName": field(default="Powiadomienia"),
        "technical.sharedInbox": field("bool", default=False),
        "technical.mainChatId": field(),
        "technical.chatId": field(),
        "technical.token": field("secret"),
        "technical.includeToolEvents": field("bool", default=True),
        "technical.includeStatusEvents": field("bool", default=True),
    },
