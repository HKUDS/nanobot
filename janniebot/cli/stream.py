...
from janniebot import __logo__
...
class ThinkingSpinner:
    """Spinner that shows 'janniebot is thinking...' with pause support."""

    def __init__(self, console: Console | None = None):
        c = console or _make_console()
        self._spinner = c.status("[dim]janniebot is thinking...[/dim]", spinner="dots")
        self._active = False
